...
import { GridComponent, ColumnsDirective, ColumnDirective, Page, Group, type Sorts, type DataResult, Sort, Inject, type DataStateChangeEventArgs, type ColumnModel } from '@syncfusion/ej2-react-grids';
...
function DataGrid(this: any) {
  ...
  const ajax: Ajax = new Ajax({
    type: 'GET', mode: true,
    onFailure: (e: Error) => { console.error(e); return false; }
  });
